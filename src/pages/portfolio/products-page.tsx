...
import { useGetAllRepoLatestTag } from "@hooks/query";
...
export const ProductsPage = () => {
	...
	const allRepoLatestTag = useGetAllRepoLatestTag();
	...
	return (
		<Page>
			...
			<Loading loading={!allRepoLatestTag.some((t) => t?.name)} />
